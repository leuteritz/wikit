  ...
  <div class="mx-auto max-w-5xl px-5 py-10">
    ...
    <section class="mb-10">
      ...
      <div class="mt-5 flex flex-wrap gap-3">
        <RouterLink to="/new" class="rounded-lg bg-[var(--color-accent)] px-4 py-2 text-sm font-semibold text-[var(--color-accent-contrast)] transition hover:bg-[var(--color-accent-hover)]">
          + Artikel anlegen
        </RouterLink>
      ...
      <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <span class="font-semibold text-slate-800 group-hover:text-[var(--color-accent)] dark:text-slate-100">{{ cat.name }}</span>
          </div>
